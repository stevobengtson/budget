...
var testTables = []string{
	...
	"incomes", "accounts", "plaid_items", "verification_tokens", "auth_lockouts", "auth_challenges", "recovery_codes", "user_totp", "webauthn_credentials", "oauth_identities", "sessions", "users",
}
