...
// Vendored from templui v1.12.1 with maia-style pill radius
// (rounded-md → rounded-full). Keep Props API identical to upstream.
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.Href != "" && !p.Disabled {
			...
			if p.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/ui/button/button.templ`, Line: 62, Col: 13}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/ui/button/button.templ`, Line: 64, Col: 31}
			}
			...
			if p.Target != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/ui/button/button.templ`, Line: 66, Col: 21}
				}
			...
			if p.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/ui/button/button.templ`, Line: 88, Col: 13}
				}
			...
			if p.Type != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/ui/button/button.templ`, Line: 104, Col: 25}
				}
			...
			if p.Form != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/ui/button/button.templ`, Line: 107, Col: 17}
				}
...
func (b Props) sizeClasses() string {
	switch b.Size {
	case SizeSm:
		return "h-8 rounded-full gap-1.5 px-3 has-[>svg]:px-2.5"
	case SizeLg:
		return "h-10 rounded-full px-6 has-[>svg]:px-4"
	case SizeIcon:
		return "size-9"
	default: // SizeDefault
